...
abstract class AppLocalizations {
  ...
  /// No description provided for @persistenceActive.
  ///
  /// In en, this message translates to:
  /// **'Local persistence is on'**
  String get persistenceActive;

  /// No description provided for @actionsSaved.
  ///
  /// In en, this message translates to:
  /// **'Actions saved in the KeyValueStore: {count}'**
  ...
  /// No description provided for @incrementAction.
  ///
  /// In en, this message translates to:
  /// **'Add action'**
