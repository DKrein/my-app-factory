...
Future<void> openPlayerSheet(BuildContext context, PlaybackController playback) =>
          ...
          return DecoratedBox(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [FactoryColors.night, FactoryColors.surface],
              ),
            ),
            child: SafeArea(
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(sound.name, style: Theme.of(context).textTheme.displaySmall),
                    ...
                    Row(
                      children: [
                        const Icon(Icons.volume_down, color: FactoryColors.mutedInk),
                        Expanded(
                          child: Slider(
                    ...
                    const Text(
                      'Sleep timer',
                      style: TextStyle(color: FactoryColors.mutedInk, fontWeight: FontWeight.w600),
                    ),
                    SizedBox(
                      height: 64,
